import {data} from '@/json/highEdu/index'
const tableConfig = [
    {
        "prop": "name",
        "label": "学科/维度"
...
export const HighEdu = {
    ...
    "modules": [
        {
            "title": "3.2.2 全区高中教育学段职业态度",
            "subTitle": "3.2.2.1 全区高中教育学段职业态度得分率与得分分布情况",
            "second": "3.2.2.2 全区高中教育学段职业态度平均分、中位数、标准差",
            "scoreRating": {
                "title": "职业态度",
        ...
        {
            "title": "3.2.3 全区高中教育学段教学实践",
            "subTitle": "3.2.3.1 全区高中教育学段教学实践得分率与得分分布情况",
            "second": "3.2.2.3 全区高中教育学段教学实践平均分、中位数、标准差",
            "scoreRating": {
                "title": "教学实践",
        ...
        {
            "title": "3.2.4 全区高中教育学段综合育人",
            "subTitle": "3.2.4.1 全区高中教育学段综合育人得分率与得分分布情况",
            "second": "3.2.2.4 全区高中教育学段综合育人平均分、中位数、标准差",
            "scoreRating": {
                "title": "综合育人",
        ...
        {
            "title": "3.2.5 全区高中教育学段自主发展",
            "subTitle": "3.2.5.1 全区高中教育学段自主发展得分率与得分分布情况",
            "second": "3.2.5.2 全区高中教育学段自主发展平均分、中位数、标准差",
            "scoreRating": {
                "title": "自主发展",
